...
const DryClean = () => {
  return (
    <section>
      <div className="pl-16 mt-10 lg:mt-20 lg:flex lg:mx-auto lg:px-16 xl:px-[7%]">
      ...
      <div className="px-4 sm:mx-12 md:px-12 md:mt-20 lg:flex lg:gap-8 lg:items-center lg:mx-auto lg:justify-center lg:mt-24 xl:mt-32 xl:px-[5%]">
        <div className="shadow-md rounded-xl p-4 border-2 lg:p-6 lg:border-2 lg:h-[200px] w-2/5 xl:w-[30%] xl:h-[250px] transform transition-transform duration-500  hover:scale-105 ">
        ...
        <div className="hidden lg:block lg:shadow-md lg:rounded-xl lg:p-6 lg:border-2 lg:h-[200px] w-2/5 xl:w-[30%] xl:h-[250px] transform transition-transform duration-500  hover:scale-105">
          <h3 className="font-semibold text-xl md:text-3xl">
          Expert Cleaning
          </h3>
